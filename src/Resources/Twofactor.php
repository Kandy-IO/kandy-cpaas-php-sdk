...
class Twofactor {
   ...
   * <li><b><samp>$params['method']</samp></b>                     <samp>string</samp> <i>optional</i> <p>Type of the authentication code delivery method, sms and email are supported types. Possible values: sms, email</p></li>
   * <li><b><samp>$params['expiry']</samp></b>                     <samp>int</samp>    <i>optional</i> <p>Lifetime duration of the code sent in seconds. This can contain values between 30 and 3600 seconds.</p></li>
   * <li><b><samp>$params['subject']</samp></b>                    <samp>string</samp> <i>optional</i> <p>When the method is passed as email then subject becomes a mandatory field to pass. The value passed becomes the subject line of the 2FA code email that is sent out to the destinationAddress.</p></li>
   * <li><b><samp>$params['length']</samp></b>                     <samp>int</samp>    <i>optional</i> <p>Length of the authentication code tha CPaaS should generate for this request. It can contain values between 4 and 10.</p></li>
   * <li><b><samp>$params['type']</samp></b>                       <samp>string</samp> <i>optional</i> <p>Type of the code that is generated. If not provided, default value is numeric. Possible values: numeric, alphanumeric, alphabetic</p></li>
   * </ul>
   * </pre>
   */
