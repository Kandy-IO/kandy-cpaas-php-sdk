...
$KANDY$ provides [Authentication API](/developer/references/php/1.1.0#twofactor-send-code) using which a two-factor authentication (2FA) flow can be implemented.
...
## Example
To learn more, check the [2FA starter app](https://github.com/Kandy-IO/kandy-cpaas-php-sdk/tree/v1.1.0/examples/2fa).

## References
For all two factor authentication related method details, refer to [Two Factor Authentication](/developer/references/php/1.1.0#twofactor-send-code).
